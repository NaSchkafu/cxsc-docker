...
inline real operator +(const real &a,const real &b) noexcept { return a.w+b.w; }
inline real operator -(const real &a,const real &b) noexcept { return a.w-b.w; }
inline real operator *(const real &a,const real &b) noexcept { return a.w*b.w; }
inline real operator /(const real &a,const real &b) noexcept { return a.w/b.w; }

inline real& operator +=(real &a, const real &b) noexcept { a.w+=b.w; return a; }
inline real& operator -=(real &a, const real &b) noexcept { a.w-=b.w; return a; }
inline real& operator *=(real &a, const real &b) noexcept { a.w*=b.w; return a; }
inline real& operator /=(real &a, const real &b) noexcept { a.w/=b.w; return a; }

inline bool operator!  (const real& a)                noexcept { return !a.w; }
inline bool operator== (const real& a, const real& b) noexcept { return a.w==b.w; }
inline bool operator!= (const real& a, const real& b) noexcept { return a.w!=b.w; }
inline bool operator<  (const real& a, const real& b) noexcept { return a.w<b.w;  }
inline bool operator<= (const real& a, const real& b) noexcept { return a.w<=b.w; }
inline bool operator>= (const real& a, const real& b) noexcept { return a.w>=b.w; }
...
inline bool operator== (const real& a, const int & b) noexcept { return a.w==b; }
inline bool operator!= (const real& a, const int & b) noexcept { return a.w!=b; }
inline bool operator== (const int & a, const real& b) noexcept { return a==b.w; }
inline bool operator!= (const int & a, const real& b) noexcept { return a!=b.w; }
inline bool operator== (const real& a, const long & b) noexcept { return a.w==b; }
inline bool operator!= (const real& a, const long & b) noexcept { return a.w!=b; }
inline bool operator== (const long & a, const real& b) noexcept { return a==b.w; }
inline bool operator!= (const long & a, const real& b) noexcept { return a!=b.w; }
inline bool operator== (const real& a, const float & b) noexcept { return a.w==b; }
inline bool operator!= (const real& a, const float & b) noexcept { return a.w!=b; }
inline bool operator== (const float & a, const real& b) noexcept { return a==b.w; }
inline bool operator!= (const float & a, const real& b) noexcept { return a!=b.w; }
inline bool operator== (const real& a, const double & b) noexcept { return a.w==b; }
inline bool operator!= (const real& a, const double & b) noexcept { return a.w!=b; }
inline bool operator== (const double & a, const real& b) noexcept { return a==b.w; }
inline bool operator!= (const double & a, const real& b) noexcept { return a!=b.w; }
