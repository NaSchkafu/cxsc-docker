...
// --------------------------------------------------------------------------
	...
	inline void times2pown(lx_real &a, const real &n) noexcept
{
    ...
    inline real sub_real(const real &a, const real &b) noexcept
{
    ...
    inline int StagPrec(const lx_real &a) noexcept 
{ return StagPrec(a.lr); }

	 inline real expo(const lx_real &a) noexcept
	 { return (a.ex); }

	 inline int sign(const lx_real &a) noexcept 
	 { return sign(a.lr); }

	 inline l_real lr_part(const lx_real &a) noexcept
	 { return (a.lr); }

	 inline lx_real abs(const lx_real& a) noexcept
	 { return lx_real(a.ex,abs(a.lr)); }
	 
	 inline lx_real adjust(const lx_real &a) noexcept
	 { return lx_real(a.ex,adjust(a.lr)); }
	 
	 inline void times2pown_neg(lx_real& a, const real& n) noexcept
...
//		 int k;
	 ...
	 inline lx_real & lx_real::operator = (const lx_real &a) noexcept
	 {
		 ex = a.ex;
		 lr = a.lr;
		 return *this;
	 ...
	 inline lx_real & lx_real::operator = (const l_real &a) noexcept
	 {
		 ex = 0;
		 lr = a;
		 return *this;
	 ...
	 inline lx_real & lx_real::operator = (const real &a) noexcept
	 {
		 ex = 0;
		 lr = a;
		 return *this;
...
// -----------------------------------------------------
	 ...
	 inline bool eq_zero(const lx_real &a) noexcept
	 {  return (a.lr == 0 );  }

	 inline bool gr_zero(const lx_real &a) noexcept
	 {  return (a.lr > 0 );  }

	 inline bool ge_zero(const lx_real &a) noexcept
	 {  return (a.lr >= 0);  }

	 inline bool sm_zero(const lx_real &a) noexcept
	 {  return (a.lr < 0 );  }

	 inline bool se_zero(const lx_real &a) noexcept
	 {  return (a.lr <= 0);  }

// -----------------------------------------------------

	 inline lx_real operator -(const lx_real &a) noexcept
	 { return lx_real(a.ex,-a.lr); }

	 inline lx_real operator +(const lx_real &a) noexcept
	 { return a; }

	 inline lx_real operator + (const lx_real& a, const l_real& b) noexcept
	 { return a + lx_real(b); }
	 inline lx_real operator + (const l_real& a, const lx_real& b) noexcept
	 { return lx_real(a) + b; }
	 inline lx_real operator + (const lx_real& a, const real& b) noexcept
	 { return a + lx_real(l_real(b)); }
	 inline lx_real operator + (const real& a, const lx_real& b) noexcept
	 { return lx_real(l_real(a)) + b; }

	 inline lx_real & operator +=(lx_real& a, const lx_real& b) noexcept
	 { return a = a+b; }
	 inline lx_real & operator +=(lx_real& a, const l_real& b) noexcept
	 { return a = a+b; }
	 inline lx_real & operator +=(lx_real& a, const real& b) noexcept
	 { return a = a+b; }

	 inline lx_real operator - (const lx_real& a, const lx_real& b) noexcept
	 { return a + lx_real(-b); }
	 inline lx_real operator - (const lx_real& a, const l_real& b) noexcept
	 { return a + lx_real(-b); }
	 inline lx_real operator - (const l_real& a, const lx_real& b) noexcept
	 ...
	 inline bool operator ! (const lx_real& a) noexcept
	 { return !a.lr; }

	 inline bool operator == (const lx_real &a, const l_real &b) noexcept
	 {  return (a==lx_real(b));  }

	 inline bool operator == (const l_real &a, const lx_real &b) noexcept
	 {  return (lx_real(a)==b);  }

	 inline bool operator == (const lx_real &a, const real &b) noexcept
	 {  return (a==lx_real(b));  }

	 inline bool operator == (const real &a, const lx_real &b) noexcept
	 {  return (lx_real(a)==b);  }


	 inline bool operator != (const lx_real &a, const lx_real &b) noexcept
	 {  return !(a==b); }
