...
inline interval sin    (const interval &a) noexcept { return j_sin(a); }
inline interval cos    (const interval &a) noexcept { return j_cos(a); }
inline interval tan    (const interval &a) noexcept { return j_tan(a); }
inline interval cot    (const interval &a) noexcept { return j_cot(a); }
...
inline interval exp    (const interval &a) noexcept { return j_exp(a); }
...
inline interval sinh   (const interval &a) noexcept { return j_sinh(a); }
inline interval cosh   (const interval &a) noexcept { return j_cosh(a); }
inline interval tanh   (const interval &a) noexcept { return j_tanh(a); }
inline interval coth   (const interval &a) noexcept { return j_coth(a); }
