...
inline lx_interval Blow(const lx_interval& a) noexcept
...
inline lx_interval & lx_interval::operator = (const lx_interval &a) noexcept
{
    ex = a.ex;
    li = a.li;
    return *this;
...
inline lx_interval & lx_interval::operator = (const lx_real &a) noexcept
{
    ex = expo(a);
    li = lr_part(a);
    return *this;
...
inline lx_interval & lx_interval::operator = (const l_interval &a) noexcept
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const l_real & a) noexcept
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const real & a) noexcept
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval & lx_interval::operator = (const interval & a) noexcept
{
    ex = 0;
    li = a;
    return *this;
...
inline lx_interval operator+(const lx_interval & a) noexcept { return a; }
inline lx_interval operator-(const lx_interval & a) noexcept
{  return lx_interval(a.ex,-a.li);  }

inline lx_interval operator + (const lx_interval &a, const l_interval &b) noexcept
{  return a + lx_interval(b); }

inline lx_interval operator + (const l_interval &a, const lx_interval &b) noexcept
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const l_real &b) noexcept
{  return a + lx_interval(b); }

inline lx_interval operator + (const l_real &a, const lx_interval &b) noexcept
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const lx_real &b) noexcept
{  return a + lx_interval(b); }

inline lx_interval operator + (const lx_real &a, const lx_interval &b) noexcept
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const real &b) noexcept
{  return a + lx_interval(b); }

inline lx_interval operator + (const real &a, const lx_interval &b) noexcept
{  return lx_interval(a) + b; }

inline lx_interval operator + (const lx_interval &a, const interval &b) noexcept
{  return a + lx_interval(b); }

inline lx_interval operator + (const interval &a, const lx_interval &b) noexcept
{  return lx_interval(a) + b; }

inline lx_interval & operator +=(lx_interval &a, const lx_interval &b) noexcept
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const l_interval &b) noexcept
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const l_real &b) noexcept
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const lx_real &b) noexcept
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const real &b) noexcept
{  return a = a+b; }

inline lx_interval & operator +=(lx_interval &a, const interval &b) noexcept
{  return a = a+b; }

inline lx_interval operator - (const lx_interval &a, const lx_interval &b) noexcept
{  return a + lx_interval(-b); }
...
inline bool operator ! (const lx_interval& a) noexcept
{ return !a.li; }

inline bool operator == (const lx_interval &a, const lx_interval &b) noexcept
{
...
inline bool operator == (const lx_interval &a, const l_interval &b) noexcept
{  return (a == lx_interval(b)); }

inline bool operator == (const l_interval &a, const lx_interval &b) noexcept
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const interval &b) noexcept
{  return (a == lx_interval(b)); }

inline bool operator == (const interval &a, const lx_interval &b) noexcept
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const real &b) noexcept
{  return ( a == lx_interval(b)); }

inline bool operator == (const lx_interval &a, const l_real &b) noexcept
{  return ( a == lx_interval(b)); }

inline bool operator == (const real &a, const lx_interval &b) noexcept
{  return ( lx_interval(a) == b); }

inline bool operator == (const l_real &a, const lx_interval &b) noexcept
{  return ( lx_interval(a) == b); }

inline bool operator == (const lx_interval &a, const lx_real &b) noexcept
{  return ( a == lx_interval(b)); }

inline bool operator == (const lx_real &a, const lx_interval &b) noexcept
{  return ( lx_interval(a) == b); }
...
inline lx_interval adjust(const lx_interval &a) noexcept
{  return lx_interval(a.ex,adjust(a.li));  }

inline lx_interval abs(const lx_interval &a) noexcept
{  return lx_interval(a.ex,abs(a.li));  }

inline bool point_intv(const lx_interval &a)
{  return point_intv(a.li);  }

inline void times2pown(lx_interval &a, const real& n) noexcept
{  a = lx_interval(add_real(n,a.ex),a.li); }

inline void times2pown_neg(lx_interval& a, const real& n) noexcept
...
inline lx_real Inf(const lx_interval &a) noexcept
{  return lx_real(a.ex,Inf(a.li));  }

inline lx_real Sup(const lx_interval &a) noexcept
...
inline lx_real diam(const lx_interval &a) noexcept
{  return lx_real(a.ex,diam(a.li)); }

inline lx_real mid(const lx_interval& a) noexcept
{  return lx_real(a.ex,mid(a.li)); }

inline bool IsEmpty(const lx_interval& a) noexcept
...
inline lx_interval operator |(const lx_real &a, const lx_real &b) noexcept
{
