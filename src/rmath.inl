...
inline real sqr(const real &arg) noexcept { return (arg*arg); }
...
inline real sin(const real & arg) noexcept { return q_sin(*(double*)&arg); } // { return t_std_fct_call(t_sine,arg); }
inline real cos(const real & arg) noexcept { return q_cos(*(double*)&arg); } // { return t_std_fct_call(t_cose,arg); }
inline real tan(const real & arg) noexcept { return q_tan(*(double*)&arg); } //{ return t_std_fct_call(t_tane,arg); }
inline real cot(const real & arg) noexcept { return q_cot(*(double*)&arg); } //{ return t_std_fct_call(t_cote,arg); }
...
inline real expm1(const real & arg)noexcept { return q_expm(*(double*)&arg); } // { return t_std_fct_call(t_exme,arg); }
inline real lnp1(const real & arg)       { return q_lg1p(*(double*)&arg); } // { return t_std_fct_call(t_lnpe,arg); }

inline real exp(const real & arg) noexcept { return q_exp(*(double*)&arg); } // { return t_std_fct_call(t_expe,arg); }
...
inline real sinh(const real & arg) noexcept { return q_sinh(*(double*)&arg); } // { return t_std_fct_call(t_snhe,arg); }
inline real cosh(const real & arg) noexcept { return q_cosh(*(double*)&arg); } // { return t_std_fct_call(t_cshe,arg); }
inline real tanh(const real & arg) noexcept { return q_tanh(*(double*)&arg); } // { return t_std_fct_call(t_tnhe,arg); }
inline real coth(const real & arg) noexcept { return q_coth(*(double*)&arg); } // { return t_std_fct_call(t_cthe,arg); }
