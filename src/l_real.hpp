...
//                                               { return l_real(a); }
      ...
      */
...
#else
      //! Constructor of class l_real
      explicit INLINE l_real(const l_rvector &)       noexcept;
      //! Constructor of class l_real
      explicit INLINE l_real(const l_rvector_slice &) noexcept;
      //! Constructor of class l_real
      explicit INLINE l_real(const l_rmatrix &)       noexcept;
      //! Constructor of class l_real
      explicit INLINE l_real(const l_rmatrix_slice &) noexcept;
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      /*!
      \deprecated use standard contructors for typecasting
      ...
      \sa l_real(const l_rvector &)
      */
      friend INLINE real _l_real(const l_rvector &)       noexcept;
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      /*!
      \deprecated use standard contructors for typecasting
      ...
      \sa l_real(const l_rvector_slice &)
      */
      friend INLINE real _l_real(const l_rvector_slice &) noexcept;
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      /*!
      \deprecated use standard contructors for typecasting
      ...
      \sa l_real(const l_rmatrix &)
      */
      friend INLINE real _l_real(const l_rmatrix &)       noexcept;
      //! Deprecated typecast, which only exist for the reason of compatibility with older versions of C-XSC
      /*!
      \deprecated use standard contructors for typecasting
      ...
      \sa l_real(const l_rmatrix_slice &)
      */
      friend INLINE real _l_real(const l_rmatrix_slice &) noexcept;
#endif
