...
inline l_real sqr(const l_real &x) noexcept 
   { return (x*x); }
inline l_real sqrt(const l_real & x,int n) 
   { return mid(sqrt(_l_interval(x),n)); }
inline l_real sqrtp1m1(const l_real & x) noexcept
   { return mid(sqrtp1m1(_l_interval(x))); }
inline l_real sqrtx2m1(const l_real & x) noexcept 
   { return mid(sqrtx2m1(_l_interval(x))); } // sqrt(x^2-1);
inline l_real sqrt1mx2(const l_real& x) noexcept 
...
inline l_real sin(const l_real & x) noexcept 
   { return mid(sin(_l_interval(x))); }
inline l_real cos(const l_real & x) noexcept 
   { return mid(cos(_l_interval(x))); }
inline l_real tan(const l_real & x) noexcept 
   { return mid(tan(_l_interval(x))); }
inline l_real cot(const l_real & x) noexcept 
...
inline l_real exp(const l_real & x) noexcept 
   { return mid(exp(_l_interval(x))); }
inline l_real exp2(const l_real & x) noexcept 
{ return mid(exp2(_l_interval(x))); }
inline l_real exp10(const l_real & x) noexcept 
{ return mid(exp10(_l_interval(x))); }
inline l_real expm1(const l_real &x) noexcept
   { return mid(expm1(l_interval(x))); }
inline l_real expmx2(const l_real& x) noexcept 
...
inline l_real sinh(const l_real & x) noexcept 
   { return mid(sinh(_l_interval(x))); }
inline l_real cosh(const l_real & x) noexcept 
   { return mid(cosh(_l_interval(x))); }
inline l_real tanh(const l_real & x) noexcept 
   { return mid(tanh(_l_interval(x))); }
inline l_real coth(const l_real & x) noexcept 
