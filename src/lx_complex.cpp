...
// ----------------------------------------------------------------------------
	...
	l_complex & l_complex::operator = (const lx_complex& a) noexcept
{
	l_real u,v;
	u = Re(a);  v = Im(a);
	...
	complex & complex::operator = (const lx_complex& a) noexcept
{
	l_complex x;
	complex y;
	...
	void operator >> (const char *s, lx_complex& a) noexcept
{
	...
	lx_real abs  (const lx_complex& a) noexcept
{ return sqrtx2y2(a.re,a.im); }
	lx_real abs2 (const lx_complex& a) noexcept
...
lx_complex sqr(const lx_complex& z) noexcept { return (z*z); }
lx_complex sqrt(const lx_complex& z) noexcept
{ return mid(sqrt(lx_cinterval(z))); }
	
lx_complex sqrt(const lx_complex& z,int n) noexcept
{ return mid( sqrt(lx_cinterval(z),n) ); }
	
lx_complex exp(const lx_complex& z) noexcept
{ return mid(exp(lx_cinterval(z))); }
	
lx_complex exp2(const lx_complex& z) noexcept
{ return mid(exp2(lx_cinterval(z))); }

lx_complex exp10(const lx_complex& z) noexcept
{ return mid(exp10(lx_cinterval(z))); }

lx_complex sin(const lx_complex& z) noexcept
{ return mid(sin(lx_cinterval(z))); }

lx_complex cos(const lx_complex& z) noexcept
{ return mid(cos(lx_cinterval(z))); }

lx_complex tan(const lx_complex& z) noexcept
{ return mid(tan(lx_cinterval(z))); }

lx_complex cot(const lx_complex& z) noexcept
{ return mid(cot(lx_cinterval(z))); }	

lx_complex asin(const lx_complex& z) noexcept
{ return mid(asin(lx_cinterval(z))); }

lx_complex acos(const lx_complex& z) noexcept
{ return mid(acos(lx_cinterval(z))); }

lx_complex atan(const lx_complex& z) noexcept
{ return mid(atan(lx_cinterval(z))); }

lx_complex acot(const lx_complex& z) noexcept
{ return mid(acot(lx_cinterval(z))); }

lx_complex sinh(const lx_complex& z) noexcept
{ return mid(sinh(lx_cinterval(z))); }

lx_complex cosh(const lx_complex& z) noexcept
{ return mid(cosh(lx_cinterval(z))); }

lx_complex tanh(const lx_complex& z) noexcept
{ return mid(tanh(lx_cinterval(z))); }

lx_complex coth(const lx_complex& z) noexcept
{ return mid(coth(lx_cinterval(z))); }

lx_complex asinh(const lx_complex& z) noexcept
{ return mid(asinh(lx_cinterval(z))); }

lx_complex acosh(const lx_complex& z) noexcept
{ return mid(acosh(lx_cinterval(z))); }

lx_complex atanh(const lx_complex& z) noexcept
{ return mid(atanh(lx_cinterval(z))); }

lx_complex acoth(const lx_complex& z) noexcept
...
lx_real arg(const lx_complex& z) noexcept
...
lx_complex ln(const lx_complex& z) noexcept
{ return mid(ln(lx_cinterval(z))); }

lx_complex log2(const lx_complex& z) noexcept
{ return mid(log2(lx_cinterval(z))); }
lx_complex log10(const lx_complex& z) noexcept
{ return mid(log10(lx_cinterval(z))); }

lx_complex power_fast(const lx_complex& z, const real& n) noexcept
{
	if( n == 0 )
...
lx_complex power(const lx_complex& x, const real& n) noexcept
{
	if( !(Is_Integer(n)) )
	//  n is not an integer
	cxscthrow(STD_FKT_OUT_OF_DEF(
...
lx_complex pow(const lx_complex& z, const lx_real& p) noexcept
{ return mid( pow( lx_cinterval(z) , lx_interval(p) ) ); }

lx_complex pow(const lx_complex& z, const lx_complex& p) noexcept	
{ return mid( pow( lx_cinterval(z) , lx_cinterval(p) ) ); }

lx_complex sqrt1px2(const lx_complex& z) noexcept
{ return mid(sqrt1px2(lx_cinterval(z))); }

lx_complex sqrt1mx2(const lx_complex& z) noexcept
{ return mid(sqrt1mx2(lx_cinterval(z))); }

lx_complex sqrtx2m1(const lx_complex& z) noexcept
{ return mid(sqrtx2m1(lx_cinterval(z))); }

lx_complex sqrtp1m1(const lx_complex& z) noexcept
{ return mid(sqrtp1m1(lx_cinterval(z))); }

lx_complex expm1(const lx_complex& z) noexcept
{ return mid(expm1(lx_cinterval(z))); }

lx_complex lnp1(const lx_complex& z) noexcept
